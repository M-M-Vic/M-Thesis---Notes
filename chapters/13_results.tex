...
Table~\ref{tab:conv:rates} collects the empirical convergence rates. Both models approach
Model~$A$ at first order in their distinguishing parameter --- $L_1$ slopes of $0.847$
($C_2$) and $0.873$ ($B_2$), each within $0.16$ of the theoretical exponent $1$. The
slight shortfall below unity is a finite-truncation and finite-grid artefact of the
log--log fit, not a genuine fractional rate; it does not exceed the $0.1$--$0.2$ tolerance
band and requires no further investigation.
...
\begin{figure}[H]
  ...
  (2)~$\mathbb{E}[W_1]$ versus $\rho$ for all models; (3)~$L_1$ convergence $C_2\to A$ and
