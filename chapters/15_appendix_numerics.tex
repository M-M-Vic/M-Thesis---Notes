\appendix
\section{Extended numerical validation and comparison}\label{app:numerics}

This appendix collects the full figure-by-figure evidence summarised in
Section~\ref{sec:results}: the per-result validation maps, the simulation cross-checks, the
...
% =====================================================================
\subsection{Validation against the CTMC}\label{app:numerics:validation}
...
moderately loaded regime. This is the single conditionally accepted entry of the
validation table and the one place where the alternative coordinatisation
...
\subsubsection{Cross-validation: simulation versus the CTMC}
