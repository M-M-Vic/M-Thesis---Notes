...
\end{corollary}
As in Model-$B$, the proof follows trivially by setting $x=y=z$ in our fundamental equation (Equation~\eqref{eq:B2:fundamental}). The surviving equation is identical to the homologous in Model-$A$, and the result is proven in Corollary~\ref{cor:A:pi0}.
