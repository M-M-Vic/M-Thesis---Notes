...
In the same fashion, we introduce the concept of the \textbf{Partial Probability Generating Function (PPGF)}. This technique, notably utilized by Cohen \cite{cohen1956delay}, consists of transforming only a subset of the random variables while maintaining the discrete indices of the remainder. In the context of a priority queue, this method is particularly advantageous: it allows us to exploit the well-known properties of the priority class (often a standard $M/M/1$ system) and focus the analytical effort on the non-trivial PGF of the non-priority class.
