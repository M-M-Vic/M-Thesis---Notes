...
The queueing diagrams in Figure \ref{fig:models-queue-overview} show a more visual representation of Model-$X$ and each of the variants that we will consider:
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{%
...
linear-reneging mechanism of the $M/M/1+M$ queue introduced in the Preliminaries section \ref{sec:prelim}.
...
In this subsection, we will see the flow diagram of Model-$X$, for both state space $S$ and $\widetilde{S}$ separately. For each of them, the balance equations are derived and stated.
