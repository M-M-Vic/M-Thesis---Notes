...
\end{equation}
That this ratio equals the continued fraction~\eqref{eq:erlangA:bp_lst} follows from the three-term recurrence for $\,{}_1F_1$ in its first parameter~\cite{dlmf}, which is precisely the ratio recursion~\eqref{eq:erlangA:r_recursion} derived in~\S\ref{ssec:erlangA}.
