\section{Comparison of Models $A$, $B_2$, and $C_2$}
...
\subsection*{Effect of jockeying: Model~$A$ $\to$ Model~$B_2$}
...
\subsection*{Effect of abandonment: Model~$A$ $\to$ Model~$C_2$}
...
\subsection*{Structural comparison of Models $B_2$ and C$_2$}
