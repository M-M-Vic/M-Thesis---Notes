...
For the general Model-$X$, the bivariate PGF satisfies a functional equation with terms of three kinds: algebraic coefficients, partial derivatives in $x$ ---from jockeying and abandonment in class-$1$--- and partial derivatives in $y$ ---from the same mechanisms in class-$2$. When both kinds of derivative terms are present, the equation belongs to a family of integro-differential equations whose solution would require more advanced tools. The problem is moreover asymmetric: derivative terms from the non-priority class complicate the equation more than those from the priority class alone.
