...
\begin{figure}[H]
    ...
    \resizebox{0.65\textwidth}{!}{%
        \input{figures/model-a-diagram.tikz}%
    }
    \caption{State-transition diagram for Model~A on state space $S$.
    Only arrivals ($\lambda_i$) and service ($\mu$) are present;
    all jockeying and abandonment rates are zero.}
    \label{fig:model-a-diagram}
\end{figure}
