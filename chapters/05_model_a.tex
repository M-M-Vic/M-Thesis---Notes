...
This proof appears in Cohen's work \cite{cohen1956delay}, and itt consists on keeping the Class-$1$ index as a discrete parameter and forming the PGF only with respect to $N_2$, defining $\widetilde{P}(n_1,y)=\sum_{n_2\geq0}\pi(n_1,n_2)\,y^{n_2}$. Multiplying the balance equations by $y^{n_2}$ and summing all over their respective domains yields a second-order linear recurrence in $n_1$ whose characteristic roots determine the geometric structure of the solution in $n_1$.
