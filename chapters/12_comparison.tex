...
it to $\ENtwoCtwoNinety$ --- a factor of nearly four --- because the self-regulating valve $\theta_1 n_1$
...
load than $C_2$ ($\pi_0=\piZeroCHSeventy$, $\mathbb{E}[N]=\ENCHSeventy$ at $\rho=0.70$). The full sweep suite
...
class~2: at $\rho=0.70$, $B_2$ raises $\mathbb{E}[W_2]$ to $\EWtwoBtwoSeventy$ from the baseline $\EWtwoASeventy$
($+\EWtwoBtwoInflationSeventy\%$), the direct cost of displaced class-1 customers joining the tail of the class-2
