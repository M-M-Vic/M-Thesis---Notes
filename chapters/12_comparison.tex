...
shed} --- against a system loss of only $L=\lossSysCtwoCanon$, the difference reflecting that the
...
$\theta_1$-sweep of Figure~\ref{fig:c2:abandonment} gives $L_1$ growing from $\lossCtwoThetaLow$ at
$\theta_1=0.05$ to $\lossCtwoThetaHigh$ at $\theta_1=5.0$ (at $\rho=0.70$): a strong valve eventually sheds
