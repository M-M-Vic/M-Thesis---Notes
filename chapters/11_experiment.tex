\section{Analysis of Model~$B_2^1$ ($\gamma_1>0$ head-of-line, $\gamma_2=\theta_1=\theta_2=0$)}
\label{sec:model_b21}
...
\subsubsection{Analytical approach for Model~$B_2^1$}\label{sssec:B21:analytical}
...
\subsubsection{Probabilistic approach for Model~$B_2^1$}\label{sssec:B21:probabilistic}
...
% ═════════════════════════════════════════════════════════════════════════════
\section{Analysis of Model~$C_2^1$ ($\theta_1>0$ head-of-line, $\gamma_1=\gamma_2=\theta_2=0$)}
\label{sec:model_c21}
...
\subsubsection{Analytical approach for Model~$C_2^1$}\label{sssec:C21:analytical}
...
\subsubsection{Probabilistic approach for Model~$C_2^1$}\label{sssec:C21:probabilistic}
