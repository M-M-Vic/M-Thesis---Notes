...
\begin{proof}[Proof of Theorem~\ref{thm:A:PGF}, probabilistic approach.]
    ...
    \end{equation*}
    Under non-preemptive priority, the priority queue operates autonomously (memorylessness of residual service time), so $\mathbb{P}(N_1=0 \mid \text{busy})=1-\rho_1$ by the geometric law of the ordinary $M/M/1$ queue with arrival rate $\lambda_1$ and service rate $\mu$. Combined with $\mathbb{P}(\text{busy})=\rho$, we have
    \begin{equation*}
