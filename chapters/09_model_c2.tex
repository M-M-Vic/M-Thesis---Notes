...
Here the surviving abandonment factor $(x-1)$ places the operative singularity on the boundary $x=1$, exactly the boundedness-pinning regime anticipated in the remark following Lemma~\ref{lem:gen:fundamental_equation}.
