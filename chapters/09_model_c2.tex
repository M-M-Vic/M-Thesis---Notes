...
In this section, we will derive $P(x,y)$ for this model where only true abandonments coming from class-$1$ take place, while no abandonments in class-$2$ or jockeying of any sort are taken into account. Figure~\ref{fig:model-c2-queue} shows the queue layout.
