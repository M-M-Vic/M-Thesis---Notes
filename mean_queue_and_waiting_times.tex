...
\title{Archive: Mean Queue Lengths and Mean Waiting Times\\
\large (removed from the main thesis; preserved verbatim)}
...
\bigskip
\noindent\emph{This file collects the mean-queue-length and mean-waiting-time
derivations for the five solved models, removed from the main thesis to keep
the focus on the generating-function structure. They are reproduced here
unchanged. Cross-references to the main document do not resolve in this
standalone file.}
